...
export enum HttpErrorsType {
  ...
  EXPIRATION_INVALID = 'ExpiredTokenException',
  ...
  PHONE_ALREADY_EXISTS_EXCEPTION = 'PhoneNumberAlreadyExistsException',
  DOCUMENT_ALREADY_EXISTS_EXCEPTION = 'DocumentAlreadyExistsException',
  ACCOUNT_NOT_CONFIRMED_EXCEPTION = 'AccountNotConfirmedException'
}
