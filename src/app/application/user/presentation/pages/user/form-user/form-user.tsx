...
import { UserModel } from '~/app/application/user/domain/model/user-model';
import { STATE_JSON } from '~/app/presentation/common/constants/general/states';
import { MaskOptionsEnum } from '~/app/presentation/common/enums/mask-enum';
import { filterCitiesById } from '~/app/presentation/common/helpers/citites/filter-cities-by-id';
import { filterCitiesByState } from '~/app/presentation/common/helpers/citites/filter-cities-by-state';
import { getOptions } from '~/app/presentation/common/helpers/get-options-select';
import {
  InputCep,
  SelectInput,
  TextInput
